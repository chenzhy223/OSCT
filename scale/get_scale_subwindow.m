...
% 此函数的详细说明。
function out_feature = get_scale_subwindow(im, pos, base_target_sz, ...
    scaleFactors, scale_model_sz, cell_size, sample_resize)
